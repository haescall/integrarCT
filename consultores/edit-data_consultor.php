...
if (isset($_POST['btn-update'])) {
    ...
    if ($crud_usuario->actualizarRol($email_contacto, $codigo_rol) &&
            $crud_consultor->update($id, $tipo_documento, $documento, $nombres, $apellidos, $cargo, $telefono, $direccion, $fecha_ingreso, $estado, $email_contacto)) {
...
if (isset($_GET['edit_id'])) {
    $id = $_GET['edit_id'];
    extract($crud_consultor->getConsultorUsuario($id));
}
?>
        ...
        <table class='table table-bordered'>
            ...
            <tr class="success">
                ...
                <td>
                    <select name="tipo_documento" class='form-control' required>
                        <option select value="<?php echo $tipo_documento; ?>">
                            <?php
            ...
            <tr class="success">
                ...
                <td><input type='text' name='documento' class='form-control' 
                           value="<?php echo $documento; ?>" required></td>
            </tr>

            <tr class="success">
                <td>Nombres</td>
                <td><input type='text' name='nombres' class='form-control'
                           value="<?php echo $nombres; ?>" required></td>
            </tr>

            <tr class="success">
                <td>Apellidos</td>
                <td><input type='text' name='apellidos' class='form-control' 
                           value="<?php echo $apellidos; ?>" required></td>
            </tr>

            <tr class="success">
                <td>Cargo</td>
                <td><input type='text' name='cargo' class='form-control' 
                           value="<?php echo $cargo; ?>" required></td>
            </tr>

            <tr class="success">
                <td>Teléfono</td>
                <td><input type='text' name='telefono' class='form-control' 
                           value="<?php echo $telefono; ?>" required></td>
            </tr>

            <tr class="success">
                <td>Dirección</td>
                <td><input type='text' name='direccion' class='form-control' 
                           value="<?php echo $direccion; ?>" required></td>
            </tr>
            ...
            <tr class="success">
                ...
                <td>
                    <div class="hero-unit">
                        <input name="fecha_ingreso" type="text" 
                               placeholder="Click para ingresar la fecha"  
                               id="fecha" class='form-control' value="<?php echo $fecha_ingreso; ?>" required>
                    </div>
                </td>
            </tr>
            <tr class="success">
                    ...
                    <select name="codigo_rol" class="form-control" required>
                        ...
                        if ($stmt->rowCount() > 0) {
                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                ?>
                                <?php if ($row['id'] == $codigo_rol) { ?>
                                    <option value="<?php echo $codigo_rol; ?>"
                                            selected><?php print($row['nombre_rol']); ?></option>
                                        <?php } if ($row['id'] != $codigo_rol) { ?>
                                    <option value="<?php print($row['id']); ?>"> 
                                        <?php print($row['nombre_rol']); ?> </option>
                                    <?php
                                }
                            }
                        }
            ...
            <tr>
                <td colspan="2">
                    ...
                    <a href="consultor.php" class="btn btn-large btn-success">
