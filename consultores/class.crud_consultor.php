    ...
    public function infoDetalladaConsultor($fechaIni, $fechaFin, $consultorID) {
        try {
            $stmt = $this->db->prepare("SELECT a.id as id_consultor, concat(a.nombres,  '  ',  a.apellidos) "
                    ...
                    . "e.id as id_fase, e.descripcion as nombre_fase, f.valor_hora_consultoria, "
                    ...
                    . "consultoria d, fases e, consultoria_consultor f "
                    . "where a.id = b.codigo_consultor and c.id = d.codigo_cliente "
                    . "and b.codigo_consultoria = d.id and b.codigo_fase = e.id "
                    . "and b.codigo_consultoria = f.codigo_consultoria and "
                    . "b.codigo_consultor = f.codigo_consultor "
