...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <tr class="success">
            <td>Horas</td>
            <td><input type='text' name='horas_laboradas' class='form-control' value="<?php echo $horas_laboradas; ?>" required></td>
        </tr>
        <tr class="success">
            <td>Valor</td>
        ...
        <tr class="success">
                ...
                <td><textarea name="actividades" class="form-control"  rows="3" required><?php echo $actividades; ?></textarea></td>
            </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                ...
                <a href="consultorias_ejecutadas.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; CANCELAR</a>
            </td>
        </tr>
