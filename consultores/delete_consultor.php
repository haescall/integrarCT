...
<div class="container">
	 ...
	 if(isset($_GET['delete_id']))
	 {
         ...
         <?php
         $stmt = $DB_con->prepare("SELECT id, tipo_documento, documento, nombres, apellidos, cargo, telefono, direccion, fecha_ingreso, estado, email_contacto FROM consultor WHERE id=:id");
