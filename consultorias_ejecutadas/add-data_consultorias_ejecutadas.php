...
if(isset($_POST['btn-save']))
{
    ...
    $codigo_consultoria = $_GET['id_consul'];
...
<div class="container">
    ...
    <table class='table table-bordered'>
        ...
        <td colspan="2">
            ...
            <a href="consultorias_ejecutadas.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; RETORNAR A CONSULTORIAS EJECUTADAS</a>
            </td>
        </tr>
